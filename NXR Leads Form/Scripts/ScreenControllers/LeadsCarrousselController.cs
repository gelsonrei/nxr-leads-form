...
namespace Nxr.FormLeads
{
    public class LeadsCarrousselController : MonoBehaviour
    {
        ...
        private float stepsColumnWidth = 23.5f;
        ...
        {
            isAwaking = false;
            stepsColumnWidth = tableLayoutSteps.ColumnWidths[0];
            ResetInputFields();
            CleanInputs();
        }
        ...
        private void ForceUpdateTableLayout()
        {
            ...
            for (int i = 0; i < tableLayoutSteps.ColumnWidths.Count; i++)
            {
                tableLayoutSteps.ColumnWidths[i] = stepsColumnWidth;
            }

            //recalcula o comprimento
            RectTransform rect = tableLayoutSteps.GetComponent<RectTransform>();
            rect.sizeDelta = new Vector2( tableLayoutSteps.ColumnWidths[0] * tableLayoutSteps.ColumnWidths.Count, rect.sizeDelta.y);

            tableLayoutSteps.UpdateLayout();
            tableLayoutFields.UpdateLayout();
        }
